...
export const utf8ToBase64 = (str: string) => btoa(String.fromCharCode(...new TextEncoder().encode(str)));
export const base64ToUtf8 = (b64_str: string) => new TextDecoder().decode(base64ToArrayBuffer(b64_str));
